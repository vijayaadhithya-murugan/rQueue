...
const TicketList: React.FC<TicketListProps> = ({ tickets, rawTickets, isLoading }) => {
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-8">
        ...
        <h3 className="text-xl font-semibold text-white">Triage in Progress...</h3>
  ...
  if (tickets.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-8">
        ...
        <h3 className="text-xl font-semibold text-white">Ready for Triage</h3>
  ...
  return (
    <div className="space-y-4 p-4 sm:p-6 h-[calc(100vh-200px)] overflow-y-auto">
      {tickets.map(ticket => {
