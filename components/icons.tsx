...
export const UserGroupIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.542 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m7.542 2.72a8.963 8.963 0 01-1.082 3.163m-13.5 0a8.963 8.963 0 011.082-3.163m11.338 0a9.06 9.06 0 00-3.162-1.082m-7.542 0a9.06 9.06 0 013.162-1.082m5.42 0a9.065 9.065 0 01-1.082 3.163m-5.42 0c-2.176.623-3.87 2.29-4.682 4.41M12 12c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z" />
    </svg>
);

export const LightBulbIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a7.5 7.5 0 01-7.5 0c-1.421-.492-2.694-1.2-3.75-2.099M15.182 14.597A4.5 4.5 0 0112 13.5a4.5 4.5 0 01-3.182 1.097m6.364 0a4.5 4.5 0 00-6.364 0m12.728 0a11.95 11.95 0 01-4.5 0m-8.228 0a11.95 11.95 0 014.5 0M9 10.5a3 3 0 116 0 3 3 0 01-6 0z" />
    </svg>
);
